...
\usepackage[pdftex, hidelinks,
            pdftitle={Q-Learning Leaves in Behaviour Trees},
            pdfauthor={Martin Estgren and Erik S. V. Jansson},
            pdfsubject={Artificial Intelligence - Planning},
            pdfkeywords={artificial intelligence, q-learning,
                         behaviour trees, shooter}]{hyperref}
...
\title{\textbf{Q-Learning Leaves in Behaviour Trees}\\
       \Large{\emph{--- Artificial Intelligence for a 2-D Quake Arena ---}}}
