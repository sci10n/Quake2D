...
\vspace{0.5em}
    ...
    \section{Implementation Details} \label{sec:implementation_details}
        ...
        \begin{figure}[H]
            ...
            \caption{Visualization of the path finding stack \(\mathcal{S}\). If there are no obstacles in the way (line-of-sight check), the agent takes a straight-line path instead.}
