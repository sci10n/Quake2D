    ...
    \section{Results and Screenshots} \label{sec:results_and_screenshots}
        ...
        \begin{figure}[H]
            ...
            \begin{minipage}{\textwidth}  
                ...
                \caption{Fitness over generations when evaluating against a hard-coded bot. Higher score is better. The solid bar represents 75\% of the fitness variance.}
                \label{fig:fitness-against-bot}
            \end{minipage}
            \begin{minipage}{\textwidth}  
                \includegraphics[width=\textwidth]{share/result-random.png}
                \caption{Fitness over generations when evaluating against 2 random peers. Higher score is better. The solid bar represents 75\% of the fitness variance.}
